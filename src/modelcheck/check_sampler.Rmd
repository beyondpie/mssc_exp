---
title: "Check gene-wise negative binomial model in MSSC"
author: Songpeng Zu
...
# Abstract
Following Jun's suggestions, here we eval the sampler firstly by generating from the prior. 
...
y <- vapply(seq_len(sample_cellnum * num_of_ind),
  FUN = function(i) {
    rnbinom(
      n = 1,
