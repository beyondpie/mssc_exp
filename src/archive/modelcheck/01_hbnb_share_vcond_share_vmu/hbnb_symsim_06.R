...
## we use the old symsim dataset generated by
## 3-1_symsim_to_bagwiff.R script.

## but the quality of the dataset is not that good
## also the total cells are 2000, each ind has 200 cells.
