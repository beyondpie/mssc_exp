...
symsim_dea_fpbatch <- mysymsim$symsim_de_analysis(
  symsimumi_batcheffect,
  popA_idx = which(symsimumi_batcheffect$cell_meta$pop == 1),
  popB_idx = which(symsimumi_batcheffect$cell_meta$pop == 2)
)
